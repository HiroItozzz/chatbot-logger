...
対話型AIのログを記録した特定の形式のJSONファイルを解析・要約し、学習記録としてはてなブログへ自動投稿するツール。  
...
- [ ] **LINE通知メッセージ内容強化** - アップロードするとAI生成の労いの言葉が返ってくるように
- [ ] **GUI追加** - 設定・実行の簡易化
...
当初はフォルダ監視での運用を目標に考えていましたが、ドラッグアンドドロップが最適解かもと感じています。  
